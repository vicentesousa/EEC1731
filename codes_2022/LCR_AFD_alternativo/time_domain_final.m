...
[CN_PD_s LCR CPV AFD_s FT]= Cross_N_PD(Y_T_db,ten_dB_below,ts);

disp('Simulation Result: Number of Crossing per 0.1 sec "PD: Positive Direction"')
LCR                       % simulation crossing number during 0.1 sec
...
disp({'Simulation Result: Fraction of time when signal goes below specific level';'Total duration of fade per second'})
FT
